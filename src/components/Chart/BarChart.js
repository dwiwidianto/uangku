...
import { Tooltip, XAxis, YAxis, Legend, CartesianGrid, LineChart, Line, DateTime } from "recharts";
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              >
                ...
                <Line name="Expense Cost" type="monotone" dataKey="cost" stroke="#8884d8" />
              </LineChart>
            </div>
          </div>
        </div>
            ...
            <div className="col-md-4">
              <div className="col-md-4">
                ...
                >
                  ...
                  <Tooltip />
                  <Legend verticalAlign="top" height={36} />
                  <Line name="Income Cost" type="monotone" dataKey="cost" stroke="#8884d8" />
                </LineChart>
              </div>
            </div>
          </div>
